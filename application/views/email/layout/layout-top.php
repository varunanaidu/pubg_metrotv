...
<div id="main-wrapper">
	<div id="header" style="padding:20px;border-bottom:1px solid #DDD;">
		<!-- <img src="<?= base_url(); ?>/media/site/images/logo_mainma.png" alt="Media Academy" /> -->
		<div id="logo_text" style="font:bold 20px Verdana;letter-spacing:2px;margin-bottom:5px;text-shadow:3px 3px 2px rgba(0,0,0,0.2);">Metro TV</div>
		<div>
