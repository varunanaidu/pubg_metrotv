      ...
      <div class="row m-t-25">
        <div class="col-sm-6 col-lg-3">
          <div class="overview-item overview-item--c1">
            <a href="<?php echo site_url("sysadmin/registran");?>">
         ...
         <div class="col-sm-6 col-lg-3">
          <div class="overview-item overview-item--c1">
            <a href="<?php echo site_url("sysadmin/approved");?>">
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  <div class="icon">
                    <i class="fa fa-inbox" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="overview-item overview-item--c1">
            <a href="<?php echo site_url("sysadmin/reject");?>">
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  <div class="icon">
                    <i class="fa fa-inbox" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="overview-item overview-item--c1">
            <a href="<?php echo site_url("sysadmin/all");?>">
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  <div class="icon">
                    <i class="fa fa-inbox" aria-hidden="true"></i>
